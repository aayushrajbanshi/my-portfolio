  ...
  return (
    <ThemeProvider>
      <MotionConfig reducedMotion="user">
        ...
        <div className="orb -left-24 top-24 h-72 w-72 bg-[var(--indigo)]" aria-hidden="true" />
        <div className="orb -right-24 top-[55vh] h-80 w-80 bg-[var(--violet)]" style={{ animationDelay: '-6s' }} aria-hidden="true" />
        <Navbar />
        <main id="main">
          <Hero />
          <About />
